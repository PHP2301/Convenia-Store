...
const translations = {
  vi: {
    ...
    "ck go tự hào cung cấp các dịch vụ tiện ích đa dạng và chất lượng nhất":
      "Convenia tự hào cung cấp các dịch vụ tiện ích đa dạng và chất lượng nhất",
    ...
    "ck convenience store vietnam - chuỗi cửa hàng tiện lợi - mở cửa 24/7":
      "CK Convenience Store Vietnam - Chuỗi cửa hàng tiện lợi - Mở cửa 24/7",
    "công ty tnhh bán lẻ ck việt nam - giấy cnđkdn: 0306182043":
      "CÔNG TY TNHH BÁN LẺ CK VIỆT NAM - Giấy CNĐKDN: 0306182043",
    "ngày cấp: 10/11/2008. nơi cấp: sở kế hoạch - đầu tư tp. hồ chí minh":
      "Ngày cấp: 10/11/2008. Nơi cấp: Sở Kế hoạch - Đầu tư Tp. Hồ Chí Minh",
    "địa chỉ: 160 bùi thị xuân, phường bến thành, quận 1, thành phố hồ chí minh, việt nam.":
      "Địa chỉ: 160 Bùi Thị Xuân, Phường Bến Thành, Quận 1, Thành phố Hồ Chí Minh, Việt Nam.",
    ...
    "nhập mã otp 6 chữ số đã được gửi đến email của bạn để xác nhận giao dịch":
      "Nhập mã OTP 6 chữ số đã được gửi đến email của bạn để xác nhận giao dịch",
    "nhập mã otp 6 chữ số đã được gửi đến email của bạn để xác nhận giao dịch:":
      "Nhập mã OTP 6 chữ số đã được gửi đến email của bạn để xác nhận giao dịch:",
    "xác nhận thanh toán": "Xác nhận thanh toán",
    "thanh toán chuyển khoản vietqr": "Thanh toán chuyển khoản VietQR",
    "vui lòng quét mã qr dưới đây bằng app ngân hàng để thanh toán":
      "Vui lòng quét mã QR dưới đây bằng app Ngân hàng để thanh toán",
    "vui lòng quét mã qr dưới đây bằng app ngân hàng để thanh toán:":
      "Vui lòng quét mã QR dưới đây bằng app Ngân hàng để thanh toán:",
    ...
    "đăng ký thiết bị an toàn (windows hello / touch id) để đăng nhập và thanh toán nhanh không cần mật khẩu.":
      "Đăng ký thiết bị an toàn (Windows Hello / Touch ID) để đăng nhập và thanh toán nhanh không cần mật khẩu.",
    ...
    "quét mã qr bằng ứng dụng google authenticator để kích hoạt 2fa.":
      "Quét mã QR bằng ứng dụng Google Authenticator để kích hoạt 2FA.",
    "hoặc nhập mã tay": "Hoặc nhập mã tay",
    "nhập mã xác thực 6 chữ số từ ứng dụng trên điện thoại của bạn":
      "Nhập mã xác thực 6 chữ số từ ứng dụng trên điện thoại của bạn",
    ...
    "lỗi tải dữ liệu. vui lòng kiểm tra kết nối với máy chủ api.":
      "Lỗi tải dữ liệu. Vui lòng kiểm tra kết nối với máy chủ API.",
  ...
  en: {
    ...
    "ck go tự hào cung cấp các dịch vụ tiện ích đa dạng và chất lượng nhất":
      "Convenia is proud to provide the most diverse and high-quality services",
    ...
    "ck convenience store vietnam - chuỗi cửa hàng tiện lợi - mở cửa 24/7":
      "CK Convenience Store Vietnam - Convenience Store Chain - Open 24/7",
    "công ty tnhh bán lẻ ck việt nam - giấy cnđkdn: 0306182043":
      "CK VIETNAM RETAIL CO., LTD - Business Registration No: 0306182043",
    "ngày cấp: 10/11/2008. nơi cấp: sở kế hoạch - đầu tư tp. hồ chí minh":
      "Issued on: 10/11/2008. Issued by: HCMC Department of Planning and Investment",
    "địa chỉ: 160 bùi thị xuân, phường bến thành, quận 1, thành phố hồ chí minh, việt nam.":
      "Address: 160 Bui Thi Xuan, Ben Thanh Ward, District 1, Ho Chi Minh City, Vietnam.",
    ...
    "nhập mã otp 6 chữ số đã được gửi đến email của bạn để xác nhận giao dịch":
      "Enter the 6-digit OTP sent to your email to confirm the transaction",
    "nhập mã otp 6 chữ số đã được gửi đến email của bạn để xác nhận giao dịch:":
      "Enter the 6-digit OTP sent to your email to confirm the transaction:",
    "xác nhận thanh toán": "Confirm Payment",
    "thanh toán chuyển khoản vietqr": "VietQR Bank Transfer Payment",
    "vui lòng quét mã qr dưới đây bằng app ngân hàng để thanh toán":
      "Please scan the QR code below with your banking app to pay",
    "vui lòng quét mã qr dưới đây bằng app ngân hàng để thanh toán:":
      "Please scan the QR code below with your banking app to pay:",
    ...
    "đăng ký thiết bị an toàn (windows hello / touch id) để đăng nhập và thanh toán nhanh không cần mật khẩu.":
      "Register secure device (Windows Hello / Touch ID) for passwordless login and checkout.",
    ...
    "nhập mã xác thực 6 chữ số từ ứng dụng trên điện thoại của bạn":
      "Enter the 6-digit verification code from your mobile app",
    ...
    "lỗi tải dữ liệu. vui lòng kiểm tra kết nối với máy chủ api.":
      "Error loading data. Please check your connection to the API server.",
  ...
  ko: {
    ...
    "ck go tự hào cung cấp các dịch vụ tiện ích đa dạng và chất lượng nhất":
      "Convenia는 우수한 편의 서비스를 제공하기 위해 최선을 다하고 있습니다",
    ...
    "công ty tnhh bán lẻ ck việt nam - giấy cnđkdn: 0306182043":
      "CK 베트남 소매 유한회사 - 사업자 등록 번호: 0306182043",
    "ngày cấp: 10/11/2008. nơi cấp: sở kế hoạch - đầu tư tp. hồ chí minh":
      "발급일: 2008년 11월 10일. 발급기관: 호치민 기획투자국",
    "địa chỉ: 160 bùi thị xuân, phường bến thành, quận 1, thành phố hồ chí minh, việt nam.":
      "주소: 베트남 호치민시 1군 벤탄동 부이티쑤언 160",
    ...
    "đăng ký thiết bị an toàn (windows hello / touch id) để đăng nhập và thanh toán nhanh không cần mật khẩu.":
      "비밀번호 없이 로그인 및 빠른 결제를 위해 보안 기기(Windows Hello / Touch ID)를 등록하세요.",
    ...
    "quét mã qr bằng ứng dụng google authenticator để kích hoạt 2fa.":
      "2FA를 활성화하려면 Google Authenticator 앱으로 QR 코드를 스캔하세요.",
